...
NOTES
=====
This stow assumes the home directory is git home directory used for the global .gitconfig file. Manually symlink .gitconfig if the intended global config location is elsewhere.
